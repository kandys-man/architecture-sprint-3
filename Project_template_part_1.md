...
2. Домен: Кабинет самообслуживания 
   - поддомен управления сценариями
   - поддомен контроля телеметрии
   - поддомен выбора и подключения модулей умного дома (устройств)

3. Домен: Управление отоплением

4. Домен: Управление освещением

5. Домен: Управление автоматическими воротами

6. Домен: Видео-наблюдение за домом
...
```markdown
[Диаграмма контекста в модели C4](System context.png)
```
